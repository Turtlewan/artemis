...
- **✅ RESOLVED 2026-06-23 — architecture-validation reservations: all decided AND applied (A–J).** Research
  ...
  `docs/drafts/architecture-validation-reservations.md`. **Open follow-up:** ADR-027 is cited (CLAUDE.md/report 03) but
  has no file — decide whether to formalize the Codex-primary/ladder ADR or treat ADR-022/026 as sufficient.
